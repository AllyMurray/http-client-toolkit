...
describe('store-dynamodb index exports', () => {
  it('re-exports DynamoDB store classes and table utilities', () => {
    ...
    expect(dynamodb.createTable).toBeTypeOf('function');
    expect(dynamodb.ensureTable).toBeTypeOf('function');
