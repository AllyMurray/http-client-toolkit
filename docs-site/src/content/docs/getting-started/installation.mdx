...
Optional browser-based UI for monitoring your stores.
...
:::tip
The dashboard auto-detects which store backend you're using and adapts its capabilities accordingly. See the [Dashboard guide](/http-client-toolkit/dashboard/overview/) for setup details.
:::
